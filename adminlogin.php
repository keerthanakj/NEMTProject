...
if(!isset($_SESSION['is_adminlogin']))
{
    if(isset($_REQUEST['aEmail']))
    {
        ...
        $SQLInsert = "SELECT a_email, a_password FROM adminlogin_db WHERE a_email = '".$aEmail."' AND a_password = '".$aPassword."' limit 1";
...
<body>
    ...
    <br>
    <p class="font-weight-bold text-center" style="font-size: 20px;"><i class="fas fa-sign-in-alt text-primary"></i> Admin Login</a></p>
